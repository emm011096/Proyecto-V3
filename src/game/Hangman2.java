...
public class Hangman2 extends JFrame implements ActionListener, WindowListener {
    ...
    String[] palabras = {"FACEBOOK", "TWITTER", "FERRARI", "MICROSOFT",
        "ANDROID", "GOOGLE", "MARVEL", "LIONSGATE", "APPLE", "WHATSAPP",
        "VINE", "YOUTUBE", "YAHOO", "WIKIPEDIA", "NESTLE", "TOSHIBA", "MACHINTOSH", "ACER", "SONY", "SAMSUNG", "LENOVO", "BIMBO", "APPSTORE", "PLAYSTORE"};//27
