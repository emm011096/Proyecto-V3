...
public class Hangman3 extends JFrame implements ActionListener, WindowListener {
    ...
    String[] palabras = {"PEAR", "APPLE", "CARROT", "STRAWBERRY",
        "GRAPE", "ORANGE", "BANANA", "PINEAPPLE", "TANGERINE", "AVOCADO",
        "LETTUCE", "BROCCOLI", "WATERMELON", "LEMON", "COCONUT", "CHERRY", "KIWI", "PEACH", "GUAVA", "POTATO", "TOMATO", "COAL", "PAPAYA", "PEAS"};//27
